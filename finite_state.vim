" Vim color file
" Name:       finite_state
" Maintainer: Wesley <wesleyprrttgithub@gmail.com>
" Homepage:   https://github.com/wesleyParriott/finite_state
" Note: This originally started as a fork of tek256's simple-dark
" Basically: dark background, with different shades of gray and colored keywords
...
let g:colors_name = "finite_state"
...
if has("gui_running") || &t_Co == 256
    ...
    hi Identifier cterm=NONE ctermfg=230 ctermbg=black gui=NONE guifg=#bcbcbc guibg=#0a0a0a
    ...
    hi String cterm=NONE ctermfg=189 ctermbg=black gui=NONE guifg=#d7d7ff guibg=#0a0a0a
    hi Comment cterm=NONE ctermfg=242 ctermbg=black gui=NONE guifg=#6c6c6c guibg=#0a0a0a
    ...
    hi String cterm=NONE ctermfg=214 ctermbg=Black
